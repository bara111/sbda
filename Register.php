...
//        $answer2 = "<script type='text/javascript'> document.write('jojo'); </script>";
//        echo $answer;
//        echo $answer2;
//        if(!strcmp($answer,$answer2))
//            echo "yessss";
//        echo "<script type='text/javascript'>  res='--yess--'; </script>";
//
//        return($answer);
//    }
//
...
//    $name = prompt($prompt_msg)."XXX";



    if(true){

    $stmt="INSERT INTO `SBDA_Accounts` (`ID`, `Username`, `Email`, `Password`, `Birthdate`, `Gender`, `Mobile`, `Weight`, `Height`, `Diseases`, `City`, `LBD`, `BloodGroup`, `Image`, `MemberShip`) VALUES (NULL, '$username', '$email', '$pass', '$bd', '$sex', '$mobile', '$weight', '$height',' $diseases', '$city', '$LBD', '$bloodgroup', 'XXXX', '0')";
...
*/
    $length=6;
    $characters = '012345678901234567890123456789ABCDE0123456789FGHIJKLMN0123456789OPQRSTUVWXYZ';
    $charactersLength = strlen($characters);
    $randomString = '';
    for ($i = 0; $i < $length; $i++) {
        $randomString .= $characters[rand(0, $charactersLength - 1)];
    }
    $_SESSION['VC']=$randomString."";

    $seven_bit_msg = $randomString;
